...
if ($action == 'articles') {
    try {
        ...
        $_SESSION['error_message'] = 'Table articles not found in database.';
        redirect(ADMIN_URL . '/export_data.php');
    }
    ...
    try {
        ...
        $_SESSION['error_message'] = 'Table projects not found in database.';
        redirect(ADMIN_URL . '/export_data.php');
    }
} elseif ($action == 'tools') {
    try {
        ...
        $_SESSION['error_message'] = 'Table tools not found in database.';
        redirect(ADMIN_URL . '/export_data.php');
    }
} else {
